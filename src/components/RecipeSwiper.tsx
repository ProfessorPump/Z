...
export function RecipeSwiper({ recipes, onLike }: RecipeSwiperProps) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-background">
      ...
      {/* Swipe Hint */}
      {currentIndex === 0 && (
        <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-30 animate-pulse">
          <div className="bg-black/30 backdrop-blur-sm rounded-full px-4 py-2 text-white text-sm font-medium flex items-center gap-2">
